  ...
  args: {
    teachers: [
      ...
      },
      {
        ...
        type: 'Presencial',
        phone: '(31) 91234-5678',
        components: 'Banco de Dados, SQL, NoSQL',
      ...
      },
      {
        ...
        type: 'Presencial',
        phone: '(41) 93456-7890',
        components: 'Redes, Segurança da Informação',
      ...
      },
      {
        ...
        type: 'EAD',
        phone: '(51) 94567-8901',
        components: 'Engenharia de Software, UML',
      ...
      },
      {
        ...
        type: 'Presencial',
        phone: '(61) 95678-9012',
        components: 'Programação Web, Angular, TypeScript',
      ...
      },
      {
        ...
        type: 'Presencial',
        phone: '(71) 96789-0123',
        components: 'Sistemas Operacionais, Linux',
      ...
      },
      {
        ...
        type: 'EAD',
        phone: '(81) 97890-1234',
        components: 'Inteligência Artificial, Machine Learning',
      ...
      },
      {
        ...
        type: 'Presencial',
        phone: '(85) 98901-2345',
        components: 'Arquitetura de Computadores',
      ...
      },
      {
        ...
        type: 'Presencial',
        phone: '(92) 90012-3456',
        components: 'Design de Interação, UX',
      ...
      },
      {
        ...
        type: 'EAD',
        phone: '(27) 91123-4567',
        components: 'Projeto Integrador, Metodologias Ágeis',
        email: 'karen.ribeiro@example.com',
      },
      {
        id: 12,
        name: 'Lucas Oliveira',
        type: 'Presencial',
        phone: '(62) 92234-5678',
        components: 'DevOps, CI/CD, Docker',
